  ...
  const busesGeoJSON = {
    ...
    features: buses.map(bus => ({
      ...
      properties: {
        ...
        headroom_capacity_substation_discharging: bus.headroom_capacity_substation_discharging,
        headroom_capacity_substation_charging: bus.headroom_capacity_substation_charging,
        headroom_capacity_substation_discharging_1: bus.headroom_capacity_substation_discharging_1,
        headroom_capacity_substation_charging_1: bus.headroom_capacity_substation_charging_1,
