...
const Analytics = () => {
  ...
  const availableDatabases = [
    { id: 'gridops_iso_ne_sample.db', name: 'gridops_iso_ne_sample.db' },
  ...
  const [selectedDatabase, setSelectedDatabase] = useState('gridops_iso_ne_sample.db');
  ...
  // Fetch data from gridops_iso_ne_sample.db
  useEffect(() => {
  ...
  // Use buses data as the primary source from gridops_iso_ne_sample.db (which contains econ table data)
